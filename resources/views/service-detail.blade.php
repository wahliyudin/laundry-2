...
<body>
    ...
    <section class="gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="carpet">
                        <i><img src="{{ asset('assets/user/img/service-icon-4.png') }}" alt="logo"></i>
                        <h3>Carpet Cleaning</h3>
                        <p>Lorem ipsum dolor sit amet cons ectetur adipisicing elit, sed do eim dolousmod sum dolor sit
                            amet cons ectetur. Lorem ipsum dolor sit amet cons ectetur adipisicing elit, sed do ei m
                            dolousmod sum dolor sit amet cons ectetur.</p>
                        <ul class="list-style">
                            <li>
                                <div class="bol"></div>Basic Clothes Irons
                            </li>
                            <li>
                                <div class="bol"></div>Assisted Living / Nursing Homes
                            </li>
                            <li>
                                <div class="bol"></div>Religious Organizations
                            </li>
                            <li>
                                <div class="bol"></div>Vertical Steam Irons
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="services-details-img">
                        <figure>
                            <img src="{{ asset('assets/user/img/services-details-1.jpg') }}" alt="services-details">
                        </figure>
                    </div>
                </div>
            </div>
    ...
    <div class="gap no-top">
        <div class="container information">
            ...
            <p>
                Phasellus enim libero, blandit vel sapienvitae, condimen tum ultricies magna Lorem ipsu fames ac turpis
                egestas. Vestibulum tortor quam , feugiat vitae, ultricie s egec tellus a od sed do eiusmod
                temincididunt ut labore et dolore magna aliqua vulputate cursus a sit a uctor Cla ss aptent taciti socio
                Etiam erat it consequat aucto odio nonnetus et malesuad quam, feugiat vitae, ultricie s egec tellus a
                odio tincidunt ilmauctor Class aptent taciti sodolore magna aliqua vulputate cursus a sit amet mveli Nam
                nec tellus a odio tincidunt ilconsequat aucto odio nonnetus et malesuada.<br><br>uctor Class aptent
                taciti socio Etiam erat it consequat aucto odio nonnetus et malesuaquam, feugiat vitae, ultricie s egec
                tellus a odio tincidunt ilmauctor Class aptent taciti sodolore magna aliqua vulputate cursus a sit amet
                mveli Nam nec tellus a odio tincidunt ilconsequat aucto odio nonnetus et malesuada.
            </p>
            <div class="package-bottom px-0">
                <ul>
                    <li><img alt="check" src="{{ asset('assets/user/img/check.png') }}">Far curiosity incommode
                        now led
                        smallness
                        allowance.</li>
                    <li><img alt="check" src="{{ asset('assets/user/img/check.png') }}">Favour bed assure son
                        things
                        yet.</li>
                    <li><img alt="check" src="{{ asset('assets/user/img/check.png') }}">She consisted consulted
                        elsewhere happiness
                    </li>
                    <li><img alt="check" src="{{ asset('assets/user/img/check.png') }}">Disposing household any
                        old
                        the.</li>
                    <li><img alt="check" src="{{ asset('assets/user/img/check.png') }}">Widow downs you new shade
                        drift
                        hopes small.
                    </li>
                    <li><img alt="check" src="{{ asset('assets/user/img/check.png') }}">Interested discretion
                        estimating on stimulated.
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="new-laundry-img">
                        <figure>
                            <img alt="img" src="{{ asset('assets/user/img/services-details-2.jpg') }}">
                        </figure>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="new-laundry-img">
                        <figure>
                            <img alt="img" src="{{ asset('assets/user/img/services-details-3.jpg') }}">
            ...
            <p>
                ...
                Etiam erat it consequat aucto odio nonnetus et malesuad quam, feugiat vitae, ultricie s egec tellus a
                odio tincidunt ilmauctor Class aptent taciti sodolore magna aliqua vulputate cursus a sit amet mveli Nam
                nec tellus a odio tincidunt ilconsequat aucto odio nonnetus et malesuada.
            </p>
            <div class="share-post">
                <h5>Share Post:</h5>
                <ul class="social-media">
                    <li><a href="#" class="f"><i class="fa-brands fa-facebook-f"></i>Facebook </a></li>
                    <li><a href="#" class="t"><i class="fa-brands fa-twitter"></i> Twitter </a></li>
                    <li><a href="#" class="in"><i class="fa-brands fa-linkedin-in"></i>Instagram</a></li>
                </ul>
            </div>
        </div>
    </div>
